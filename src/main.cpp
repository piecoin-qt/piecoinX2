...
#if defined(NDEBUG)
# error "Piecoin cannot be compiled without assertions."
#endif
...
uint256 hashGenesisBlock("0x6bd2dbd021c749a33871c3230b86fd8006727e36fdae1aaefefc6860e3913762"); //10ef5a15c8ad3525fb13d6a22e4fa9966df93b0b4e999201fb225ec6da6d53b0
static CBigNum bnProofOfWorkLimit(~uint256(0) >> 20); // Piecoin: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "Piecoin Signed Message:\n";
...
{
    // Piecoin: IsDust() detection disabled, allows any valid dust to be relayed.
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    nSubsidy >>= (nHeight / 175320); // Piecoin: 175,320 blocks in each year

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 1 * 60 * 60; // Piecoin: 1 hour
static const int64 nTargetSpacing = 3 * 60; // Piecoin: 3 minutes
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    // Piecoin: This fixes an issue where a 51% attack can change difficulty at will.
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // Piecoin: Special short-term limits to avoid 10,000 BDB lock limit:
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xddfe8b9016fc4e42acccc2c8de7d5d5d20c441cc2c20595316a7628de6b317c0");  //3904de38726d47e44e0a9eea36854c9a6cffbf086ee8c87c31d691eadf880242
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "USA 8/11/2022  We got the genesis coin for Las Vegas";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CBigNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 1024 * COIN;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("043a553342f82bd0c9649439afe288f8cbf2f4ee7e14d605cdc7b1d55900afd248169a658b50b1861c71eb72a83e6aaa08bc8e1af267c05f6a7f2f1f2e04e3a0e0") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1660253041;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 2088091628;

        if (fTestNet)
        {
            block.nTime    = 1660253041;
            block.nNonce   = 386276802;
        }
...
if (false && block.GetHash() != hashGenesisBlock)
        ...
        assert(block.hashMerkleRoot == uint256("0x2b645e2240ae5a876ad0de6455099e9c821165d772d52eb03630ee35727d2b03"));  //0xf898e1c6240103862184205d1dbf23f6d87a09d44769cc6eaa99a26729d02e6b
        block.print();
...
unsigned char pchMessageStart[4] = { 0xf8, 0xc0, 0xb0, 0xd8 }; // Piecoin: increase each by adding 2 to bitcoin's value.
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("PiecoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("PiecoinMiner : ProcessBlock, block not accepted");
    }

    return true;
}

void static PiecoinMiner(CWallet *pwallet)
{
    printf("PiecoinMiner started\n");
    SetThreadPriority(THREAD_PRIORITY_LOWEST);
    RenameThread("piecoin-miner");
    ...
    try { loop {
        ...
        printf("Running PiecoinMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
    ...
    {
        printf("PiecoinMiner terminated\n");
        throw;
    }
}
...
void GenerateBitcoins(bool fGenerate, CWallet* pwallet)
{
    ...
    for (int i = 0; i < nThreads; i++)
        minerThreads->create_thread(boost::bind(&PiecoinMiner, pwallet));
}
