...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Piecoin " + FormatFullVersion();
...
//    {"piecointools.com", "dnsseed.piecointools.com"},
//    {"piecoinpool.org", "dnsseed.piecoinpool.org"},
...
//    {"piecointools.com", "testnet-seed.piecointools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Piecoin is probably already running."), addrBind.ToString().c_str());
        else
